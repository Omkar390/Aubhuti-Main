...
#End Region
        ...
        Try
            ...
            If dsRptDtl.Tables.Count > 0 Then
                If dsRptDtl.Tables(0).Rows.Count > 0 Then
                    If dsRptDtl.Tables(0).Rows(0).Item("datefiltertype").ToString = "YQM" Then
                        ScriptManager.RegisterStartupScript(Me.Page, Me.Page.[GetType](), "callshowyear", "showyear();", True)
                    ElseIf dsRptDtl.Tables(0).Rows(0).Item("datefiltertype").ToString = "RANGE" Then
                        ScriptManager.RegisterStartupScript(Me.Page, Me.Page.[GetType](), "callshowrange", "showrange();", True)
                    Else
                        ScriptManager.RegisterStartupScript(Me.Page, Me.Page.[GetType](), "callhideyear", "hideyear();", True)
                        ScriptManager.RegisterStartupScript(Me.Page, Me.Page.[GetType](), "callhiderange", "hiderange();", True)
                    End If
                Else
                    ScriptManager.RegisterStartupScript(Me.Page, Me.Page.[GetType](), "callhideyear", "hideyear();", True)
                    ScriptManager.RegisterStartupScript(Me.Page, Me.Page.[GetType](), "callhiderange", "hiderange();", True)
        ...
        Try
            ...
            If dsRptDtl.Tables.Count > 0 Then
                If dsRptDtl.Tables(0).Rows.Count > 0 Then
                    ...
                    RptSQL = RptSQL.Replace("::ED::", "1900-01-01")
    ...
    Public Shared Function ConvertDataTabletoJson(ByVal RANGEVISIBLE As String, ByVal YQMVISIBLE As String, ByVal ddlYQM As String, ByVal ddlQVal As String, ByVal ddlMVal As String, ByVal startdate As String, ByVal enddate As String, ByVal ddlYVal As String, ByVal inputstr As String, ByVal ddlpager As String, ByVal sortcol As String, ByVal sortdir As String, ByVal sortcolname As String, ByVal qString As String) As String()
        ...
        Try
            ...
            If startdate.Equals("") Then
                startdate = CDate(Date.Now.AddDays(-180).ToShortDateString).ToString("yyyy-MM-dd")
            End If
            If enddate.Equals("") Then
                enddate = CDate(Date.Now.ToShortDateString).ToString("yyyy-MM-dd")
            End If
            ...
            records = BindGrids(RANGEVISIBLE, ddlYQM, ddlQVal, ddlMVal, startdate, enddate, ddlYVal, inputstr, ddlpager, sortcol, sortdir, sortcolname, qString)

            items(0) = ConvertDataTabletoString(RANGEVISIBLE, YQMVISIBLE, ddlYQM, ddlQVal, ddlMVal, startdate, enddate, ddlYVal, records.Tables(0), sortcol, sortdir, records.Tables(1).Rows(0)(0), sortcoljqdt, qString)
            items(1) = rptwidth '+ "%"
            items(2) = showtotals
    ...
    Public Shared Function ConvertDataTabletoString(ByVal RANGEVISIBLE As String, ByVal YQMVISIBLE As String, ByVal ddlYQM As String, ByVal ddlQVal As String, ByVal ddlMVal As String, ByVal startdate As String, ByVal enddate As String, ByVal ddlYVal As String, ByVal dt As DataTable, ByVal sortcol As String, ByVal sortdir As String, ByVal reccount As Integer, ByVal sortcoljqdt As String, ByVal qString As String) As String
                        ...
                        Else
                            ...
                            Else
                                ...
                                If YQMVISIBLE = "block" Then
                                    ...
                                    End If
                                End If
                                If RANGEVISIBLE = "visible" Then
                                    strURL = strURL + "&SD=" + startdate
                                    strURL = strURL + "&ED=" + enddate
                                End If
    ...
    Protected Shared Function BindGrids(ByVal RANGEVISIBLE As String, ddlYQM As String, ByVal ddlQVal As String, ByVal ddlMVal As String, ByVal startdate As String, ByVal enddate As String, ByVal ddlYVal As String, ByVal inputstr As String, ByVal ddlpager As String, ByVal sortcol As String, ByVal sortdir As String, ByVal sortcolname As String, ByVal qString As String) As DataSet
        Dim dsRptDtl As DataSet
        Dim RptSQL As String = ""
        ...
        Try
            ...
            strSQL = " Select PNrowid, coalesce(ColSort, '') as ColSort, coalesce(ColDir, '') as ColDir, coalesce(DisCnt, 0) as DisCnt " &
                    " from tblpagenav where clientid = @clientid " &
                    " And userid = @userid order by PNrowid desc limit 1 "
            ...
            If sortcolname = "" Then
                If dsRptSort.Tables(0).Rows(0).Item("ColSort").ToString = "" Then
                    strSQL = " Update tblpagenav set ColSort = '" & defsortcol & "', ColDir = '" & defsortdir & "', Discnt = @ddlpager " &
                ...
                Else
                    ...
                    Else
                        ...
                        If ddlpager <> "100%" Then
                            ...
                            db.ExecuteNonQuery(CommandType.Text, strSQL, parms3)
                        Else
                            strSQL = " Update tblpagenav set Discnt = 1000 where PNrowid = " & dsRptSort.Tables(0).Rows(0).Item("PNrowid").ToString
                            db.ExecuteNonQuery(CommandType.Text, strSQL, parms3)
                        End If
                    End If
                End If
            Else
                ...
                If ddlpager <> "100%" Then
                    ...
                    db.ExecuteNonQuery(CommandType.Text, strSQL, parms3)
                Else
                    strSQL = " Update tblpagenav set ColSort = '" & defsortcol & "', ColDir = '" & defsortdir & "', Discnt = 1000 " &
                            " where PNrowid = " & dsRptSort.Tables(0).Rows(0).Item("PNrowid").ToString
                    db.ExecuteNonQuery(CommandType.Text, strSQL, parms3)
                End If
            End If
            ...
            For Each item As RepeaterItem In rptvariables.Items
                If TryCast(item.FindControl("pName"), Label).Text.ToLower.Contains("date") Then
                    ...
                    If TryCast(item.FindControl("pName"), Label).Text.ToLower = "sdate" Or
                        ...
                        parms2(0) = New DBHelper.Parameters("@pvalue", TryCast(item.FindControl("pValue"), HtmlInputText).Value)
                        Dim strSQL As String = "SELECT DATE_FORMAT(STR_TO_DATE(@pvalue, '%m/%d/%Y'), '%Y-%m-%d')"
                        tmpstr = db.ExecuteScalar(CommandType.Text, strSQL, parms2).ToString()
                ...
                End If
            Next
            Response.Redirect(strReDir, False)
        Catch ex As Exception
            lblErrorMsg.Text = "Sorry ... this page does not appear to be working. The error has been logged and we are reviewing it."
            lblErrorMsg.Visible = True
            SSManager.LogAppError(ex, "lnkSaveVar_Click")
        End Try
    End Sub
        ...
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            If TryCast(e.Item.FindControl("pName"), Label).Text.ToLower.Contains("date") Then
                ...
                If TryCast(e.Item.FindControl("pName"), Label).Text.ToLower = "sdate" Or
                    ...
                    Dim db As New DBHelper
                    Dim parms2(0) As DBHelper.Parameters
                    parms2(0) = New DBHelper.Parameters("pvalue", TryCast(e.Item.FindControl("pValue"), HtmlInputText).Value)
                    Dim strSQL As String = "SELECT DATE_FORMAT(@pvalue, '%m/%d/%Y')"
                    Dim strdate As String = db.ExecuteScalar(CommandType.Text, strSQL,parms2)
                    TryCast(e.Item.FindControl("pValue"), HtmlInputText).Value = strdate
