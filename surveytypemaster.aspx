<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="surveytypemaster.aspx.vb" Inherits="surveytypemaster" title="Survey Type" %>
                ...
                <ContentTemplate>--%>
                    <asp:Repeater ID="rptMR" runat="server">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:LinkButton CommandName="Edit" CommandArgument='<%#Eval("surveytypeid").ToString() + "|" + Eval("surveytype").ToString()%>' ID="TempEdit" runat="server"
                                Text="<img src='images/edit.png' />" ToolTip="Edit"></asp:LinkButton>
                                <asp:LinkButton CommandName="Del" CommandArgument='<%#Eval("surveytypeid")%>' ID="TempDel" runat="server"
