...
Partial Class Login
    ...
    Protected Function SendMandrillHTTP(ByVal Receiver As String, ByVal ReceiverName As String, ByVal sender As String, _
        ...
        Try
            ...
            Dim json2 As String = "{" + _
                """options""" + ":" + "{" + _
                        """open_tracking""" + ":" + "" + strTrackOpens + "," + _
                        """click_tracking""" + ":" + "" + strTrackClicks + "" + _
                    "}," + _
                    """recipients""" + ":" + "[" + _
                        "{" + _
                            """address""" + ":{" + _
    ...
    Public Sub SendEmailToKarl(ByVal MailObj As MailMessage) 
        Try
			...
			MailObj.Body = "A new user has registered for SalesShark. " + "<br/>"  + "Name: " + txtfname.Text.Trim +  " " + txtlname.Text + _
