<%@ Page Language="VB" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="false" CodeFile="GroupChartsList.aspx.vb" Inherits="Users" title="Group Reports" %>
...
<%--                <asp:LinkButton ID="btnNew" PostBackUrl="~/GroupReportEdit.aspx?reportid=0" runat="server" Text="New" CssClass="new_btn"></asp:LinkButton>--%>
                <a class="new_btn" href="GroupChartEdit.aspx?reportid=0">New</a>
        ...
        <div class="list_table"><!--table listing!--> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ac_list responsive" id="sort_tab">
                ...
                <tbody>
                    <asp:Repeater ID="chartUsers" runat="server">
                        <ItemTemplate>
                            <tr>
