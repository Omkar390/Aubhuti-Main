<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="levelmaster.aspx.vb" Inherits="levelmaster" title="Level Master" %>
                ...
                <tbody>
                    <asp:Repeater ID="rptMR" runat="server">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:LinkButton CommandName="Edit" CommandArgument='<%#Eval("ctlrowid").ToString() + "|" + Eval("lname").ToString()%>' ID="TempEdit" runat="server"
                                Text="<img src='images/edit.png' />" ToolTip="Edit"></asp:LinkButton>
                                <asp:LinkButton CommandName="Del" CommandArgument='<%#Eval("ctlrowid")%>' ID="TempDel" runat="server"
            ...
            <div class="create_form"><!--Create Edit form!-->
       		...
       		<div class="create_row"><!--row !-->
       		    <div class="create_left" style="width:100%"><!--left section!-->
           	        <div class="field_name"><label>Status:</label></div>
                    <div class="inp_f">
