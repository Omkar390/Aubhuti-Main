<%@ Page Language="VB" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="false" CodeFile="GroupChartEdit.aspx.vb" Inherits="GroupChartEdit" title="Group Chart Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <section class="container"><!--container section!-->
	    <div class="heading_row topspace crasul_sec"><!--top heading!-->
        	<h2>Group Chart Edit <asp:Literal runat="server" id="lblChartName"></asp:Literal>
                <a class="new_btn" href="GroupChartsList.aspx">Back</a>&nbsp;&nbsp;&nbsp;&nbsp;
                <a class="new_btn" onclick='addtolist();'>Add Chart</a>
        	</h2>
            <div class="clr"></div>
        </div><!--top heading!-->
        ...
        <div class="process_main"> 
            <div class="process_form"><!--process form section!-->
                <table>
                    <tr>
                        <td style="width:30%">
                            <label>Chart Name (No spaces)</label>
                        </td>
                        <td style="width:30%">
                    ...
                    <tr>
                        <td>
                            <asp:TextBox ID="txtChartname" runat="server" MaxLength="50" TabIndex="1" required style="width: 180px;"></asp:TextBox>
                        </td>
                        <td>
                            <asp:TextBox ID="txtCharttitle" runat="server" MaxLength="50" TabIndex="2" required style="width: 240px;"></asp:TextBox>
                        </td>
                        <td>
                            <asp:Button ID="btnsubmit" runat="server" CssClass="mybutton" style="width: 40%;margin-left: 10%;"
                                Text="Save Chart" CausesValidation="true"/>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div class="create_row" id="colDetails" runat="server" style="overflow:auto;max-height:200px"  ><!--row !-->
                <table border="0" cellspacing="0" cellpadding="0" class="field_detail responsive" width="100%">
            	    <thead>
	                <tr>
    	                <th style="text-align:left"><strong>Chart</strong></th>
    	                <th style="text-align:left"><strong>Links</strong></th>
                    </tr>
                    </thead>
                    <tbody>
                        <asp:Repeater runat="server" ID="ChartReports" >
                            <ItemTemplate>
                            <tr class="odd gradeX">
            ...
            <div class="create_form"><!--Create Edit form!-->
                ...
                <div id="divusers" runat="server">
                    <div class="create_row"><!--row !-->
                        ...
                        <div class="n_sbt"><input type="submit" id="searchCharts" runat="server" value="GO" /></div>
                        <div class="clr"></div>
                    </div><!--row !-->
                    ...
                    <div id="divselusers" runat="server">
                        <div class="s_result"><!--current member section!-->
                            ...
                            <div class="member_list" style="overflow:auto;max-height:200px">
                                ...
                                <asp:Repeater id="ChartAccts" runat="server">
                                    <ItemTemplate>
                                        <p>
