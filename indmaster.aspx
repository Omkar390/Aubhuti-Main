<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="indmaster.aspx.vb" Inherits="indmaster" title="Industry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <section class="container"><!--sales dashboard!-->
        ...
        <input type="hidden" id="hdnTier" runat="server" />
        ...
        <div class="new_btab dataTables_wrapper"><!--table listing!--> 
            <table width="50%" border="0" cellspacing="0" cellpadding="0" class="myexample display nowrap ac_list" id="sort_tab">
            	<thead>
                <tr>
                    <th width="65%">Industry</th>
            ...
            <tbody>
                <asp:Repeater ID="rptMR" runat="server">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:LinkButton CommandName="Edit" CommandArgument='<%#Eval("indid").ToString() + "|" + Eval("industry").ToString()%>' ID="TempEdit" runat="server"
                            Text="<img src='images/edit.png' />" ToolTip="Edit"></asp:LinkButton>
                            <asp:LinkButton CommandName="Del" CommandArgument='<%#Eval("indid")%>' ID="TempDel" runat="server"
    ...
    <section class='e_detailpop' id='edittemplate'  style="display:none;height:100%"><!--Email Detail Pop up!-->
	    <div class="create_edit" style="width:50%">
            ...
            <h3 class="template_heading">Add / Edit Industry</h3>
            <div class="create_form"><!--Create Edit form!-->
                   
       		<div class="create_row"><!--row !-->
       		    <div class="create_left" style="width:100%"><!--left section!-->
           	        <div class="field_name"><label>Industry Name:</label></div>
                    <div class="inp_f">
                        <%--<input id="" runat="server" type="text" />--%>
                        <asp:TextBox ID="pMRName" runat="server" MaxLength="50"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvpMRName" Display="Dynamic" ValidationGroup="pMic"
                            runat="server" ControlToValidate="pMRName" InitialValue="">
